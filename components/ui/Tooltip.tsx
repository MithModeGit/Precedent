...
/**
 * Accessible hover/focus tooltip. The info trigger is keyboard-focusable, linked to the
 * bubble via aria-describedby, and the bubble is revealed on hover or focus-within, so the
 * citation text is reachable without a mouse.
 */
